...
public class GuiCadPaciente extends javax.swing.JInternalFrame {
 ...
 private void cadastrar() {
    try {
        ...
        pac.setEmail(jtEmail1.getText()); // Adicionando o e-mail

        // Verificação do campo Convênio
        ...
        // Validação do CPF duplicado
        PacienteDAO pacDAO = new PacienteDAO();
        if (pacDAO.verificarCpfDuplicado(pac.getCpf())) {
            JOptionPane.showMessageDialog(this, "Erro: CPF já registrado!");
            return; // Interrompe o cadastro
        }

        // Validação do formato do telefone
        String telefone = jtTelefone.getText();
        String telefoneRegex = "^\\(\\d{2}\\) \\d{5}-\\d{4}$"; // Exemplo: (21) 98002-5862
        if (!telefone.matches(telefoneRegex)) {
            JOptionPane.showMessageDialog(this, "Erro: Telefone inválido! Formato esperado: (21) 98002-5862");
            return; // Interrompe o cadastro se o telefone for inválido
        }

        // Se o CPF e o telefone forem válidos, prosseguir com o cadastro
