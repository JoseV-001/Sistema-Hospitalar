...
public class GuiJTableBuscaPaciente extends javax.swing.JInternalFrame {
    ...
    DefaultTableModel dtm = new DefaultTableModel(
            new Object[][]{},
            new Object[]{"Código", "Nome", "CPF", "RG", "Endereço", "Telefone", "E-mail", "Data Nascimento", "Convênio"});
    ...
    private void initComponents() {
        ...
        jtablePaciente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "CPF", "RG", "Endereço", "Telefone", "E-mail", "Data nascimento", "Convenio"
            }
        ) {
        ...
        jbLimpar.setBounds(20, 40, 140, 40);
        ...
        jbPreencherTabela.setBounds(700, 50, 140, 40);
    ...
    private void limparTabela() {
        ...
        dtm.setNumRows(0);
        //Limpar o campo txt(Estava faltando problema 5 corrigido)
        jtFiltro.setText("");
    }//fecha método
    ...
    try {
        ...
        for (int i = 0; i < pac.size(); i++) {
            dtm.addRow(new Object[]{
                ...
                pac.get(i).getNome(),
                pac.get(i).getCpf(),
                pac.get(i).getRg(), // faltando
                pac.get(i).getEndereco(), // faltando
                pac.get(i).getTelefone(),
                pac.get(i).getEmail(), //  faltando 
                pac.get(i).getDataNascimento(),//  faltando
                pac.get(i).getConvenio()
